...
// === Edit PDF (cloud) toolbar icons — Lucide-style ===
const IconTextPlus = (p) => (
  <I {...p}>
    <path d="M4 6V4h11v2" />
    <path d="M9.5 4v13" />
    <path d="M7 17h5" />
...
const IconScissors = (p) => (
  <I {...p}>
    ...
    <path d="M8.5 8L20 18M8.5 16L20 6" />
  </I>
);
...
const IconCloudUp = (p) => (
  <I {...p}>
    <path d="M7 18a4 4 0 0 1-.5-7.97A6 6 0 0 1 18 9a3.5 3.5 0 0 1 0 9h-1" />
    <path d="M12 13v7M9 16l3-3 3 3" />
  </I>
);
...
Object.assign(window, {
  ...
  IconTextPlus, IconMessage, IconLink, IconBold, IconItalic, IconUnderlineText,
  IconAlignLeft, IconAlignCenter, IconAlignRight, IconTrash, IconShapes,
  IconScissors, IconClipboard, IconCloudUp,
  PlinyMark,
});
