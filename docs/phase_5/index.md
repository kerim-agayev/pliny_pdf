...
- Active wave: **5D — Mobile touch** — ✅ GATE 5D passed (2026-06-07); committed + pushed (Vercel auto-deploy).
- Next step: Wave 5E — Edit PDF improvements (text-block font/color on creation, selectable-after-add, resize polish).
