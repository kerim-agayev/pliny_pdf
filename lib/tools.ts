...
export const TOOLS: Tool[] = [
  ...
  { id: "grayscale-pdf", slug: "grayscale-pdf", name: "Grayscale PDF", desc: "Convert every page to black and white.", cat: "Edit", mode: "cloud", icon: IconGrayscale, accent: "#F472B6", available: true },
